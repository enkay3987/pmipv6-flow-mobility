...
#include "ipv6-address-helper1.h"

namespace ns3 
{

NS_LOG_COMPONENT_DEFINE ("Ipv6AddressHelper1")
  ;

Ipv6AddressHelper1::Ipv6AddressHelper1 ()
{
  NS_LOG_FUNCTION (this);
  SetBase (Ipv6Address ("2001:db8::"), Ipv6Prefix (32));
}

Ipv6AddressHelper1::Ipv6AddressHelper1 (Ipv6Address network, Ipv6Prefix prefix,
                                      Ipv6Address base)
{
...
void Ipv6AddressHelper1::SetBase (Ipv6Address network, Ipv6Prefix prefix,
                            Ipv6Address base)
{
  NS_LOG_FUNCTION (this << network << prefix << base);
  m_network = network;
...
Ipv6Address Ipv6AddressHelper1::NewAddress (Address addr)
{
...
Ipv6Address Ipv6AddressHelper1::NewAddress (void)
{
  NS_LOG_FUNCTION (this);
...
void Ipv6AddressHelper1::NewNetwork (Ipv6Address network, Ipv6Prefix prefix)
{
  NS_LOG_FUNCTION (this << network << prefix);
  SetBase (network, prefix);
}

void Ipv6AddressHelper1::NewNetwork (void)
{
  NS_LOG_FUNCTION (this);
  Ipv6AddressGenerator::Init (m_network, m_prefix, m_address);
...
Ipv6InterfaceContainer Ipv6AddressHelper1::Assign (const NetDeviceContainer &c)
{
  NS_LOG_FUNCTION (this);
  ...
  for (uint32_t i = 0; i < c.GetN (); ++i) 
    {
      ...
      NS_ASSERT_MSG (node, "Ipv6AddressHelper1::Allocate (): Bad node");

      Ptr<Ipv6> ipv6 = node->GetObject<Ipv6> ();
      NS_ASSERT_MSG (ipv6, "Ipv6AddressHelper1::Allocate (): Bad ipv6");
      int32_t ifIndex = 0;
      ...
      NS_ASSERT_MSG (ifIndex >= 0, "Ipv6AddressHelper1::Allocate (): "
...
Ipv6InterfaceContainer Ipv6AddressHelper1::Assign (const NetDeviceContainer &c, std::vector<bool> withConfiguration)
{
  NS_LOG_FUNCTION (this);
  Ipv6InterfaceContainer retval;
  for (uint32_t i = 0; i < c.GetN (); ++i) 
...
Ipv6InterfaceContainer Ipv6AddressHelper1::AssignWithoutAddress (const NetDeviceContainer &c)
{
  NS_LOG_FUNCTION (this);
