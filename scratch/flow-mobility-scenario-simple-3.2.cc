...
const std::string traceFilename = "flow-mobility-scenario-simple-3.2";

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("FlowMobilityScenarioSimple3.2");
...
void InstallTcpApplication(Args args)
{
  ...
  source.SetAttribute ("SendSize", UintegerValue (1200));
...
main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("FlowMobilityScenarioSimple3.2", static_cast<LogLevel>(LOG_LEVEL_DEBUG | LOG_PREFIX_TIME));
  ...
  Simulator::Schedule (Seconds (10), &InstallApplications, args, 3);
  Simulator::Schedule (Seconds (10), &InstallTcpApplication, args);
